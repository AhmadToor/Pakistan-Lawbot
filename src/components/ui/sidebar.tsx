...
>(
  (
    ...
    // If mobile and openMobile is true, show the sidebar
    if (isMobile && openMobile) {
      return (
        <Sheet open={openMobile}  onOpenChange={setOpenMobile}  {...props}>
            ...
            data-mobile="true"
            className={`min-[500px]:w-[43%] ${sidebarVisible? 'animate-[slide-in_0.5s_ease_forwards]': 'animate-[slide-out_0.5s_ease_forwards]'}   absolute bg-white p-0 gap-1   z-[50] px-2  overflow-y-scroll no-scrollbar text-sidebar-foreground flex h-full w-full flex-col `}
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 absolute h-svh w-[--sidebar-width] bg-transparent transition-all translate-x-1/2 ease-linear",
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-2 pl-0", className)}
      {...props}
    />
  )
})
