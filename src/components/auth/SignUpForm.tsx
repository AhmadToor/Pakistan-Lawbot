        ...
        <form className= 'grid gap-4' onSubmit={handleSubmit(handleSignup)}>
          ...
          <div className="grid gap-2">
            ...
            <div className="flex items-baseline relative">
              <Input id="password" type={passwordType} placeholder="Your password" autoComplete="new-password" {...register('password')}  />
          ...
          <div className="grid gap-2">
            ...
            <div className="flex items-baseline relative">
              <Input id="confirmpassword" type={confirmPasswordType} autoComplete="password" {...register('confirmpassword')} placeholder="Confirm your password"  />
